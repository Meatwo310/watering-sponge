...
public class WateringSpongeFillerBE extends BlockEntity {
    public WateringSpongeFillerBE(BlockPos pos, BlockState state) {
        super(WSBlockEntities.WATERING_SPONGE_FILLER_BE.get(), pos, state);
    }
