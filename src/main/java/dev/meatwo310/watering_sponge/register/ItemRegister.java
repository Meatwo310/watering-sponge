...
public class ItemRegister {
    ...
    public static final RegistryObject<Item> WATERING_SPONGE_MEDIUM = BLOCKITEMS.register(
            BlockRegister.WATERING_SPONGE_MEDIUM.getId().getPath(),
            () -> new WateringSpongeBlockItem(BlockRegister.WATERING_SPONGE_MEDIUM.get())
    );

    public static final RegistryObject<Item> WATERING_SPONGE_LARGE = BLOCKITEMS.register(
            BlockRegister.WATERING_SPONGE_LARGE.getId().getPath(),
            () -> new WateringSpongeBlockItem(BlockRegister.WATERING_SPONGE_LARGE.get())
    );
